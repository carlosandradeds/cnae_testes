            ...
            "notas_fiscais": [
                {
                    ...
                    "cnpj_emitente": "12.345.678/0001-01",
...
def get_conhecimento_de_frete(numero_conhecimento: str):
    if numero_conhecimento in conhecimentos["conhecimentos"]:
        return conhecimentos["conhecimentos"][numero_conhecimento]
    else:
        return {"message": "Conhecimento de frete não encontrado"}

conhecimento = get_conhecimento_de_frete('CF12345')
print(json.dumps(conhecimento, indent=2))
